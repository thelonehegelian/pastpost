      ...
      <div className="flex flex-col items-center justify-center h-full">
        ...
        {formVisible && (
          <div className="w-1/3 bg-white p-6 rounded shadow-lg">
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Capsule Name</label>
              <input
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Capsule Type</label>
